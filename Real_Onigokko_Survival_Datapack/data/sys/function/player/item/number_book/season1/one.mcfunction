...
#チームの名前変更
#アイテム設定
    item replace entity @a[team=Hunter] armor.head with diamond_helmet[unbreakable={},enchantments={protection:1}]
    item replace entity @a[team=Hunter] armor.chest with diamond_chestplate[unbreakable={},enchantments={protection:1}]
    item replace entity @a[team=Hunter] armor.legs with diamond_leggings[unbreakable={},enchantments={projectile_protection:1}]
    item replace entity @a[team=Hunter] armor.feet with diamond_boots[unbreakable={},enchantments={protection:1}]
    item replace entity @a[team=Hunter] hotbar.0 with diamond_sword[unbreakable={},enchantments={sharpness:1}]
    ...
    item replace entity @a[team=Hunter] hotbar.4 with bow[unbreakable={},enchantments={power:1}]
