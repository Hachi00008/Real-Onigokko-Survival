...
#アイテム設定
    ...
    item replace entity @a[team=Hunter] hotbar.0 with diamond_sword[unbreakable={},enchantments={sharpness:3,fire_aspect:1}]
    ...
    item replace entity @a[team=Hunter] hotbar.4 with bow[unbreakable={},enchantments={power:3,flame:1}]
...
#スコアを設定
    scoreboard players set @a[team=Hunter] Hunter_number 6
#中心にtp
